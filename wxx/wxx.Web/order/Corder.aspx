<%@ Page Title="" Language="C#" MasterPageFile="~/order/Index.Master" AutoEventWireup="true" CodeBehind="Corder.aspx.cs" Inherits="wxx.order.Corder" %>
...
<%--        <GroupTemplate>
        ...
        <ItemTemplate>
        	<div class="address" onmouseover="this.className='addressbar'" onmouseout="this.className='address'">
                <input name="Radio1" id="Radio1" type="radio"  value='<%# Eval("ID") %>' onclick="setRadio(this);"/>

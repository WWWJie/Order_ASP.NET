    ...
    public class com_user : baseashxClass
    {
        ...
        public override void ProcessRequest(HttpContext context)
        {
            ...
            else if (context.Request.QueryString["type"] == "del")//删除信息
            {
                ...
                wxx.Common.DbHelperMySQL.ExecuteSql("delete from  Com_OrgAddUser where UserId=" + Id);
            }
            ...
            else if (context.Request.QueryString["type"] == "save")//保存修改或添加 
            {
                ...
                if (password.Trim() != "")
                    ...
                    password = wxx.Common.DbHelperMySQL.getvalue("select password from com_user where   UserId=" + userid);
                if (context.Request.QueryString["Id"] != null && context.Request.QueryString["Id"] != "")
                {
                    if (wxx.Common.DbHelperMySQL.getvalue("select id from Com_OrgAddUser where   UserId=" + userid) == "")
                        wxx.Common.DbHelperMySQL.ExecuteSql("insert into  Com_OrgAddUser(orgid,UserId) values('" + orgid + "','" + userid + "')");
                    else
                    {
                        ...
                        wxx.Common.DbHelperMySQL.ExecuteSql("update  Com_OrgAddUser set orgid='" + orgid + "' where UserId=" + userid);
                    }

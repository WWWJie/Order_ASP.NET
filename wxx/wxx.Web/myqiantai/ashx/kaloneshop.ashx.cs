...
namespace wxx.myweb.ashx
{
    ...
    public class  kaloneshop : baseashxClass
    {
        ...
        {
            wxx.BLL.kalonemerchandise cdbll = new wxx.BLL.kalonemerchandise();
            ...
            {
                string str = "";
                if (context.Request.QueryString["leibie"] == "tuijian")
                {
                    str = cdbll.GetListByColumn_tojson("*", "state=" + "'可用'", "Id");

...
namespace wxx.BLL
{
	...
	/// kaloneaddress
	/// </summary>
    public partial class kaloneaddress : System.Web.UI.Page
    {
        private readonly wxx.DAL.kaloneaddress dal = new wxx.DAL.kaloneaddress();
        ...
        public kaloneaddress(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kaloneaddress"] != null)
                strifofpage = Session["kaloneaddress"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string address, string phone, string name, string userID, string new1, string new2)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kaloneaddress model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string address, string phone, string name, string userID, string new1, string new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kaloneaddress model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kaloneaddress GetModelByCache(int Id)
        {

            string CacheKey = "kaloneaddressModel-" + Id;
            ...
            return (wxx.Model.kaloneaddress)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kaloneaddress> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kaloneaddress> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kaloneaddress> modelList = new List<wxx.Model.kaloneaddress>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kaloneaddress model;

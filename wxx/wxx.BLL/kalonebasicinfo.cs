...
namespace wxx.BLL
{
	...
	/// kalonebasicinfo
	/// </summary>
    public partial class kalonebasicinfo : System.Web.UI.Page
    {
        private readonly wxx.DAL.kalonebasicinfo dal = new wxx.DAL.kalonebasicinfo();
        ...
        public kalonebasicinfo(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kalonebasicinfo"] != null)
                strifofpage = Session["kalonebasicinfo"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string userID, string userName, string contact, string phone, string email, string address, string qq, string new1, string new2)
        {
            wxx.Model.kalonebasicinfo model = new wxx.Model.kalonebasicinfo();
                    model.userID = userID;
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kalonebasicinfo model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string userID, string userName, string contact, string phone, string email, string address, string qq, string new1, string new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kalonebasicinfo model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public wxx.Model.kalonebasicinfo GetModel(int Id)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kalonebasicinfo GetModelByCache(int Id)
        {

            string CacheKey = "kalonebasicinfoModel-" + Id;
            ...
            return (wxx.Model.kalonebasicinfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonebasicinfo> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonebasicinfo> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kalonebasicinfo> modelList = new List<wxx.Model.kalonebasicinfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kalonebasicinfo model;

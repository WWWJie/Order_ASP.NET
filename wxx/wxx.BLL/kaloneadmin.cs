...
namespace wxx.BLL
{
	...
	/// kaloneadmin
	/// </summary>
    public partial class kaloneadmin : System.Web.UI.Page
    {
        private readonly wxx.DAL.kaloneadmin dal = new wxx.DAL.kaloneadmin();
        ...
        public kaloneadmin(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kaloneadmin"] != null)
                strifofpage = Session["kaloneadmin"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string userName, string account, string password, string phone, string gender, string category, string role, string new1, string new2)
        {
            wxx.Model.kaloneadmin model = new wxx.Model.kaloneadmin();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kaloneadmin model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string userName, string account, string password, string phone, string gender, string category, string role, string new1, string new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kaloneadmin model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public wxx.Model.kaloneadmin GetModel(int Id)
        {
        ...
        public string Geteditdata(string Id)
        {
            ...
            retstr +=model.account+"|";
            retstr +=model.password+"|";
            retstr +=model.phone+"|";
            retstr +=model.gender+"|";
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kaloneadmin GetModelByCache(int Id)
        {

            string CacheKey = "kaloneadminModel-" + Id;
            ...
            return (wxx.Model.kaloneadmin)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kaloneadmin> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kaloneadmin> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kaloneadmin> modelList = new List<wxx.Model.kaloneadmin>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kaloneadmin model;

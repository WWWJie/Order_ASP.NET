...
namespace wxx.BLL
{
    ...
    {
        private readonly wxx.DAL.gwc dal = new wxx.DAL.gwc();
        ...
        public gwc(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            base.OnInit(e);
            if (Session["gwc"] != null)
                strifofpage = Session["gwc"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string userid, string foodname, float price, int count)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.gwc model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string userid, string foodname, float price, int count)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.gwc model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.gwc GetModelByCache(int Id)
        {

            string CacheKey = "gwcModel-" + Id;
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.gwc> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.gwc> DataTableToList(DataTable dt)
        {
            List<wxx.Model.gwc> modelList = new List<wxx.Model.gwc>();

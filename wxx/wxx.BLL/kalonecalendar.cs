...
namespace wxx.BLL
{
	...
	/// kalonecalendar
	/// </summary>
    public partial class kalonecalendar : System.Web.UI.Page
    {
        private readonly wxx.DAL.kalonecalendar dal = new wxx.DAL.kalonecalendar();
        ...
        public kalonecalendar(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kalonecalendar"] != null)
                strifofpage = Session["kalonecalendar"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string userName, string time, string status, string userID, string description, string importance, string memo, string new1, string new2)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kalonecalendar model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string userName, string time, string status, string userID, string description, string importance, string memo, string new1, string new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kalonecalendar model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kalonecalendar GetModelByCache(int Id)
        {

            string CacheKey = "kalonecalendarModel-" + Id;
            ...
            return (wxx.Model.kalonecalendar)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonecalendar> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonecalendar> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kalonecalendar> modelList = new List<wxx.Model.kalonecalendar>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kalonecalendar model;

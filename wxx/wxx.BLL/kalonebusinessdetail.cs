...
{
	/// <summary>
	/// kalonebusinessdetail
	/// </summary>
    public partial class kalonebusinessdetail : System.Web.UI.Page
    {
        private readonly wxx.DAL.kalonebusinessdetail dal = new wxx.DAL.kalonebusinessdetail();
        ...
        public kalonebusinessdetail(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kalonebusinessdetail"] != null)
                strifofpage = Session["kalonebusinessdetail"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string orderID, string foodID, string foodName, int amount, string new1, float new2)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kalonebusinessdetail model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string orderID, string foodID, string foodName, int amount, string new1, float new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kalonebusinessdetail model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kalonebusinessdetail GetModelByCache(int Id)
        {

            string CacheKey = "kalonebusinessdetailModel-" + Id;
            ...
            return (wxx.Model.kalonebusinessdetail)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonebusinessdetail> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonebusinessdetail> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kalonebusinessdetail> modelList = new List<wxx.Model.kalonebusinessdetail>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kalonebusinessdetail model;

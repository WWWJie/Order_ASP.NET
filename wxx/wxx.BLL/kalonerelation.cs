...
namespace wxx.BLL
{
	...
	/// kalonerelation
	/// </summary>
    public partial class kalonerelation : System.Web.UI.Page
    {
        private readonly wxx.DAL.kalonerelation dal = new wxx.DAL.kalonerelation();
        ...
        public kalonerelation(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kalonerelation"] != null)
                strifofpage = Session["kalonerelation"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string userName, string userID, string category, string level, string editTime, string new1, string new2)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kalonerelation model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string userName, string userID, string category, string level, string editTime, string new1, string new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kalonerelation model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kalonerelation GetModelByCache(int Id)
        {

            string CacheKey = "kalonerelationModel-" + Id;
            ...
            return (wxx.Model.kalonerelation)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonerelation> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonerelation> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kalonerelation> modelList = new List<wxx.Model.kalonerelation>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kalonerelation model;

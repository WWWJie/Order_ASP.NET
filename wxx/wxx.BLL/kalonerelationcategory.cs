...
{
	/// <summary>
	/// kalonerelationcategory
	/// </summary>
    public partial class kalonerelationcategory : System.Web.UI.Page
    {
        private readonly wxx.DAL.kalonerelationcategory dal = new wxx.DAL.kalonerelationcategory();
        ...
        public kalonerelationcategory(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kalonerelationcategory"] != null)
                strifofpage = Session["kalonerelationcategory"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string category, string level, string memo, string new1, string new2)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kalonerelationcategory model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string category, string level, string memo, string new1, string new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kalonerelationcategory model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kalonerelationcategory GetModelByCache(int Id)
        {

            string CacheKey = "kalonerelationcategoryModel-" + Id;
            ...
            return (wxx.Model.kalonerelationcategory)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonerelationcategory> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonerelationcategory> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kalonerelationcategory> modelList = new List<wxx.Model.kalonerelationcategory>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kalonerelationcategory model;

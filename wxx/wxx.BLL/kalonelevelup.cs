...
namespace wxx.BLL
{
	...
	/// kalonelevelup
	/// </summary>
    public partial class kalonelevelup : System.Web.UI.Page
    {
        private readonly wxx.DAL.kalonelevelup dal = new wxx.DAL.kalonelevelup();
        ...
        public kalonelevelup(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["kalonelevelup"] != null)
                strifofpage = Session["kalonelevelup"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string userName, string userID, string upgradeCategory, string upgradeLevel, string new1, string new2)
        {
            wxx.Model.kalonelevelup model = new wxx.Model.kalonelevelup();
                    model.userName = userName;
                    model.userID = userID;
                    model.upgradeCategory = upgradeCategory;
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(wxx.Model.kalonelevelup model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string userName, string userID, string upgradeCategory, string upgradeLevel, string new1, string new2)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(wxx.Model.kalonelevelup model)
        {
        ...
        public string Geteditdata(string Id)
        {
            ...
            retstr +=model.userID+"|";
            retstr +=model.upgradeCategory+"|";
            retstr +=model.upgradeLevel+"|";
            retstr +=model.new1+"|";
            retstr +=model.new2+"|";
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public wxx.Model.kalonelevelup GetModelByCache(int Id)
        {

            string CacheKey = "kalonelevelupModel-" + Id;
            ...
            return (wxx.Model.kalonelevelup)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonelevelup> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<wxx.Model.kalonelevelup> DataTableToList(DataTable dt)
        {
            List<wxx.Model.kalonelevelup> modelList = new List<wxx.Model.kalonelevelup>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                wxx.Model.kalonelevelup model;

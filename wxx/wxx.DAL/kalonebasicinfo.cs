...
namespace wxx.DAL
{
	...
	public partial class kalonebasicinfo
	{
		...
		/// 增加一条数据
		/// </summary>
        public int Add(wxx.Model.kalonebasicinfo model)
		{
			StringBuilder strSql=new StringBuilder();
         
			strSql.Append("insert into kalonebasicinfo(");
			strSql.Append("userID,userName,contact,phone,email,address,qq,new1,new2)  values (");
			strSql.Append("@userID,@userName,@contact,@phone,@email,@address,@qq,@new1,@new2)");
			strSql.Append(";");
			MySqlParameter[] parameters = {
					new MySqlParameter("@userID", MySqlDbType.VarChar,50),
					new MySqlParameter("@userName", MySqlDbType.VarChar,80),
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(wxx.Model.kalonebasicinfo model)
		{
			StringBuilder strSql=new StringBuilder();

            strSql.Append("update kalonebasicinfo set ");
		...
		public bool Delete(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from kalonebasicinfo ");
            strSql.Append(" where Id=@Id");
            MySqlParameter[] parameters = {
        ...
        public wxx.Model.kalonebasicinfo GetModel(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select   * from kalonebasicinfo ");
		...
		/// 得到一个对象实体
		/// </summary>
		public wxx.Model.kalonebasicinfo DataRowToModel(DataRow row)
		{
			wxx.Model.kalonebasicinfo model=new wxx.Model.kalonebasicinfo();
			if (row != null)
			{
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM kalonebasicinfo ");
            if (strWhere.Trim() != "")
            {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM kalonebasicinfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
        ...
        private DataSet GetListByPage(string columslist, string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from kalonebasicinfo T ");
        ...
        {
            string str = DbHelperMySQL.GetListByPageColumns_tojson(columslist, strWhere, orderby, PageSize, PageIndex, "kalonebasicinfo");
        ...
        {
            string str = DbHelperMySQL.GetListByColumns_tojson(columslist, strWhere, orderby, "kalonebasicinfo");
        ...
        {
            string strsql = DbHelperMySQL.GetListByPageColumns(columslist, strWhere, orderby, PageSize, PageIndex, "kalonebasicinfo");

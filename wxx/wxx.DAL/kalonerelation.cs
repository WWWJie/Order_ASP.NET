...
{
	/// <summary>
	/// 数据访问类:kalonerelation
	/// </summary>
	public partial class kalonerelation
	{
        public kalonerelation()
		{}
		...
		/// 增加一条数据
		/// </summary>
        public int Add(wxx.Model.kalonerelation model)
		{
			StringBuilder strSql=new StringBuilder();
         
			strSql.Append("insert into kalonerelation(");
			strSql.Append("userName,userID,category,level,editTime,new1,new2)  values (");
			strSql.Append("@userName,@userID,@category,@level,@editTime,@new1,@new2)");
			strSql.Append(";");
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@level", MySqlDbType.VarChar,255),
			...
			parameters[5].Value = model.new1;
			parameters[6].Value = model.new2;
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(wxx.Model.kalonerelation model)
		{
			StringBuilder strSql=new StringBuilder();

            strSql.Append("update kalonerelation set ");
		...
		public bool Delete(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from kalonerelation ");
            strSql.Append(" where Id=@Id");
            MySqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
        public wxx.Model.kalonerelation GetModel(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select   * from kalonerelation ");
            ...
            wxx.Model.kalonerelation model = new wxx.Model.kalonerelation();
		...
		/// 得到一个对象实体
		/// </summary>
		public wxx.Model.kalonerelation DataRowToModel(DataRow row)
		{
			wxx.Model.kalonerelation model=new wxx.Model.kalonerelation();
			if (row != null)
			{
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM kalonerelation ");
            if (strWhere.Trim() != "")
            {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM kalonerelation ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
        ...
        private DataSet GetListByPage(string columslist, string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from kalonerelation T ");
        ...
        {
            string str = DbHelperMySQL.GetListByPageColumns_tojson(columslist, strWhere, orderby, PageSize, PageIndex, "kalonerelation");
        ...
        {
            string str = DbHelperMySQL.GetListByColumns_tojson(columslist, strWhere, orderby, "kalonerelation");
        ...
        {
            string strsql = DbHelperMySQL.GetListByPageColumns(columslist, strWhere, orderby, PageSize, PageIndex, "kalonerelation");

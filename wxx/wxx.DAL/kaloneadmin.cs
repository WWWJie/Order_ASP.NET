...
namespace wxx.DAL
{
	...
	public partial class kaloneadmin
	{
		...
		/// 增加一条数据
		/// </summary>
        public int Add(wxx.Model.kaloneadmin model)
		{
			StringBuilder strSql=new StringBuilder();
         
			strSql.Append("insert into kaloneadmin(");
			strSql.Append("userName,account,password,phone,gender,category,role,new1,new2)  values (");
			strSql.Append("@userName,@account,@password,@phone,@gender,@category,@role,@new1,@new2)");
			strSql.Append(";");
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@role", MySqlDbType.VarChar,255),
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(wxx.Model.kaloneadmin model)
		{
			StringBuilder strSql=new StringBuilder();

            strSql.Append("update kaloneadmin set ");
		...
		public bool Delete(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from kaloneadmin ");
            strSql.Append(" where Id=@Id");
            MySqlParameter[] parameters = {
        ...
        public wxx.Model.kaloneadmin GetModel(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select   * from kaloneadmin ");
		...
		/// 得到一个对象实体
		/// </summary>
		public wxx.Model.kaloneadmin DataRowToModel(DataRow row)
		{
			wxx.Model.kaloneadmin model=new wxx.Model.kaloneadmin();
			if (row != null)
			{
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM kaloneadmin ");
            if (strWhere.Trim() != "")
            {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM kaloneadmin ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
        ...
        private DataSet GetListByPage(string columslist, string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from kaloneadmin T ");
        ...
        {
            string str = DbHelperMySQL.GetListByPageColumns_tojson(columslist, strWhere, orderby, PageSize, PageIndex, "kaloneadmin");
        ...
        {
            string str = DbHelperMySQL.GetListByColumns_tojson(columslist, strWhere, orderby, "kaloneadmin");
        ...
        {
            string strsql = DbHelperMySQL.GetListByPageColumns(columslist, strWhere, orderby, PageSize, PageIndex, "kaloneadmin");

...
namespace wxx.DAL
{
	...
	public partial class kalonebusinessdetail
	{
		...
		/// 增加一条数据
		/// </summary>
        public int Add(wxx.Model.kalonebusinessdetail model)
		{
			StringBuilder strSql=new StringBuilder();
         
			strSql.Append("insert into kalonebusinessdetail(");
			strSql.Append("orderID,foodID,foodName,amount,new1,new2)  values (");
			strSql.Append("@orderID,@foodID,@foodName,@amount,@new1,@new2)");
			strSql.Append(";");
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(wxx.Model.kalonebusinessdetail model)
		{
			StringBuilder strSql=new StringBuilder();

            strSql.Append("update kalonebusinessdetail set ");
		...
		public bool Delete(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from kalonebusinessdetail ");
            strSql.Append(" where Id=@Id");
            MySqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
        public wxx.Model.kalonebusinessdetail GetModel(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select   * from kalonebusinessdetail ");
            ...
            wxx.Model.kalonebusinessdetail model = new wxx.Model.kalonebusinessdetail();
		...
		/// 得到一个对象实体
		/// </summary>
		public wxx.Model.kalonebusinessdetail DataRowToModel(DataRow row)
		{
			wxx.Model.kalonebusinessdetail model=new wxx.Model.kalonebusinessdetail();
			if (row != null)
			{
                ...
                if (row["new2"] != null )
                {
                    model.new2 = float.Parse( row["new2"].ToString());
                }
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM kalonebusinessdetail ");
            if (strWhere.Trim() != "")
            {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM kalonebusinessdetail ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
        ...
        private DataSet GetListByPage(string columslist, string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from kalonebusinessdetail T ");
        ...
        {
            string str = DbHelperMySQL.GetListByPageColumns_tojson(columslist, strWhere, orderby, PageSize, PageIndex, "kalonebusinessdetail");
        ...
        {
            string str = DbHelperMySQL.GetListByColumns_tojson(columslist, strWhere, orderby, "kalonebusinessdetail");
        ...
        {
            string strsql = DbHelperMySQL.GetListByPageColumns(columslist, strWhere, orderby, PageSize, PageIndex, "kalonebusinessdetail");

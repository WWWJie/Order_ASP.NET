...
namespace wxx.DAL
{
	...
	public partial class kalonerelationcategory
	{
		...
		/// 增加一条数据
		/// </summary>
        public int Add(wxx.Model.kalonerelationcategory model)
		{
			StringBuilder strSql=new StringBuilder();
         
			strSql.Append("insert into kalonerelationcategory(");
			strSql.Append("category,level,memo,new1,new2)  values (");
			strSql.Append("@category,@level,@memo,@new1,@new2)");
			strSql.Append(";");
			MySqlParameter[] parameters = {
					new MySqlParameter("@category", MySqlDbType.VarChar,50),
			...
			parameters[3].Value = model.new1;
			parameters[4].Value = model.new2;
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(wxx.Model.kalonerelationcategory model)
		{
			StringBuilder strSql=new StringBuilder();

            strSql.Append("update kalonerelationcategory set ");
		...
		public bool Delete(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from kalonerelationcategory ");
            strSql.Append(" where Id=@Id");
            MySqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
        public wxx.Model.kalonerelationcategory GetModel(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select   * from kalonerelationcategory ");
            ...
            wxx.Model.kalonerelationcategory model = new wxx.Model.kalonerelationcategory();
		...
		/// 得到一个对象实体
		/// </summary>
		public wxx.Model.kalonerelationcategory DataRowToModel(DataRow row)
		{
			wxx.Model.kalonerelationcategory model=new wxx.Model.kalonerelationcategory();
			if (row != null)
			{
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM kalonerelationcategory ");
            if (strWhere.Trim() != "")
            {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM kalonerelationcategory ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
        ...
        private DataSet GetListByPage(string columslist, string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from kalonerelationcategory T ");
        ...
        {
            string str = DbHelperMySQL.GetListByPageColumns_tojson(columslist, strWhere, orderby, PageSize, PageIndex, "kalonerelationcategory");
        ...
        {
            string str = DbHelperMySQL.GetListByColumns_tojson(columslist, strWhere, orderby, "kalonerelationcategory");
        ...
        {
            string strsql = DbHelperMySQL.GetListByPageColumns(columslist, strWhere, orderby, PageSize, PageIndex, "kalonerelationcategory");

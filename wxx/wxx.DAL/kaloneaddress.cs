...
namespace wxx.DAL
{
	...
	public partial class kaloneaddress
	{
		...
		/// 增加一条数据
		/// </summary>
        public int Add(wxx.Model.kaloneaddress model)
		{
			StringBuilder strSql=new StringBuilder();
         
			strSql.Append("insert into kaloneaddress(");
			strSql.Append("address,phone,name,userID,new1,new2)  values (");
			strSql.Append("@address,@phone,@name,@userID,@new1,@new2)");
			strSql.Append(";");
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(wxx.Model.kaloneaddress model)
		{
			StringBuilder strSql=new StringBuilder();

            strSql.Append("update kaloneaddress set ");
		...
		public bool Delete(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from kaloneaddress ");
            strSql.Append(" where Id=@Id");
            MySqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
        public wxx.Model.kaloneaddress GetModel(int Id)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select   * from kaloneaddress ");
            ...
            wxx.Model.kaloneaddress model = new wxx.Model.kaloneaddress();
		...
		/// 得到一个对象实体
		/// </summary>
		public wxx.Model.kaloneaddress DataRowToModel(DataRow row)
		{
			wxx.Model.kaloneaddress model=new wxx.Model.kaloneaddress();
			if (row != null)
			{
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM kaloneaddress ");
            if (strWhere.Trim() != "")
            {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM kaloneaddress ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
        ...
        private DataSet GetListByPage(string columslist, string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from kaloneaddress T ");
        ...
        {
            string str = DbHelperMySQL.GetListByPageColumns_tojson(columslist, strWhere, orderby, PageSize, PageIndex, "kaloneaddress");
        ...
        {
            string str = DbHelperMySQL.GetListByColumns_tojson(columslist, strWhere, orderby, "kaloneaddress");
        ...
        {
            string strsql = DbHelperMySQL.GetListByPageColumns(columslist, strWhere, orderby, PageSize, PageIndex, "kaloneaddress");
